...
export class Post extends Entity<string> {
  ...
  constructor(id: string, description: string, uploadDate: Date, creator: string, discussionId: string, upVotedUsers: Vote[], downVotedUsers: Vote[], edited: boolean, creatorUser: User) {
    super();
    this.setId(id);
